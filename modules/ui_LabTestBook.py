...
################################################################################
## Form generated from reading UI file 'LabTestBook.ui'
##
...
"}")
        ...
        self.label_demo = QLabel(self.frame__demo)
        self.label_demo.setObjectName(u"label_demo")

        self.verticalLayout_3.addWidget(self.label_demo)
...
"border-bottom-right-radius:10px;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.titleRightInfo.setText(QCoreApplication.translate("MainWindow", u"Book Lab Test", None))
